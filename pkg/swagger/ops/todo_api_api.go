...
func NewTodoAPIAPI(spec *loads.Document) *TodoAPIAPI {
	return &TodoAPIAPI{
		...
		DeleteTasksIDHandler: DeleteTasksIDHandlerFunc(func(params DeleteTasksIDParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation DeleteTasksID has not yet been implemented")
		}),
		GetTasksHandler: GetTasksHandlerFunc(func(params GetTasksParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation GetTasks has not yet been implemented")
		}),
		GetTasksIDHandler: GetTasksIDHandlerFunc(func(params GetTasksIDParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation GetTasksID has not yet been implemented")
		}),
		PatchTasksIDHandler: PatchTasksIDHandlerFunc(func(params PatchTasksIDParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation PatchTasksID has not yet been implemented")
		}),
		...
		PostTasksHandler: PostTasksHandlerFunc(func(params PostTasksParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation PostTasks has not yet been implemented")
		}),
...
/*TodoAPIAPI API for todo.antrwdev.ru. */
type TodoAPIAPI struct {
	...
	// PatchTasksIDHandler sets the operation handler for the patch tasks ID operation
	PatchTasksIDHandler PatchTasksIDHandler
	...
	// PostTasksHandler sets the operation handler for the post tasks operation
...
func (o *TodoAPIAPI) Validate() error {
	...
	if o.PatchTasksIDHandler == nil {
		unregistered = append(unregistered, "PatchTasksIDHandler")
	}
	...
	if o.PostTasksHandler == nil {
		unregistered = append(unregistered, "PostTasksHandler")
	}
...
func (o *TodoAPIAPI) initHandlerCache() {
	...
	o.handlers["PATCH"]["/tasks/{id}"] = NewPatchTasksID(o.context, o.PatchTasksIDHandler)
	...
	o.handlers["POST"]["/tasks"] = NewPostTasks(o.context, o.PostTasksHandler)
}
